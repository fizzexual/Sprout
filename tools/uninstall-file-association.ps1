# Removes the .sprout / .bloom file associations created by
# install-file-association.ps1 (and any leftover Botanica registrations).
...
# Leftover Botanica entries from older installs.
...
Remove-Item -Path 'HKCU:\Software\Classes\Directory\shell\Botanica' -Recurse -Force
Remove-Item -Path 'HKCU:\Software\Classes\Directory\Background\shell\Botanica' -Recurse -Force
...
Write-Host "Removed the Sprout/Bloom file associations." -ForegroundColor Yellow
