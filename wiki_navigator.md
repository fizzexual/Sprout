...
| Page | What's inside |
| --- | --- |
| [Command line & flags](wiki/cli-and-flags.md) | Every `sprout` command (incl. `bundle` → a standalone exe, `format` → tidy code), plus `--sandbox`, `SPROUT_SANDBOX`, `SPROUT_GC_STRESS` |
