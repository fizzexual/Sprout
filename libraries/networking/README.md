...
| [`web.ts`](web.ts) | weather, mac_vendor, ssl_expiry, cert, dns, headers, shorten, expand, filesize | [Web & data](../../wiki/libraries/networking-web.md) |
| [`security.ts`](security.ts) | is_vpn, captive_portal, whos_home, portscan, services, use_dns, on_new_device | [Security & presence](../../wiki/libraries/networking-security.md) |
